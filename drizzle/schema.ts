...
export const fileTemplates = mysqlTable("file_templates", {
  ...
  thumbnailUrlSmall: text("thumbnailUrlSmall"),
  thumbnailUrlMedium: text("thumbnailUrlMedium"),
  thumbnailUrlLarge: text("thumbnailUrlLarge"),
  thumbnailUrlSmallWebp: text("thumbnailUrlSmallWebp"),
  thumbnailUrlMediumWebp: text("thumbnailUrlMediumWebp"),
  thumbnailUrlLargeWebp: text("thumbnailUrlLargeWebp"),
