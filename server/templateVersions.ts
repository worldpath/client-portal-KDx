...
export async function uploadNewTemplateVersion(params: {
  ...
  const result = await db.insert(templateVersions).values({
    ...
    thumbnailUrlSmall: thumbnail?.thumbnailUrls.small || null,
    thumbnailUrlMedium: thumbnail?.thumbnailUrls.medium || null,
    thumbnailUrlLarge: thumbnail?.thumbnailUrls.large || null,
    thumbnailUrlSmallWebp: thumbnail?.thumbnailUrls.smallWebp || null,
    thumbnailUrlMediumWebp: thumbnail?.thumbnailUrls.mediumWebp || null,
    thumbnailUrlLargeWebp: thumbnail?.thumbnailUrls.largeWebp || null,
    downloadCount: 0,
    isLatest: 1,
